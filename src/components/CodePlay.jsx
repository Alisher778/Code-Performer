...
class CodePlayground extends Component {
  constructor(props) {
    super(props);
    this.state = {
      code1: { showTime: '0', execTime: '', msg: '', status: '', perform: null },
  ...
  evalCode() {
    ...
    this.setState({
      code1: { showTime: avarageValue.toFixed(3), execTime: avarageValue, msg: code1Msg, status: status1, perform: perform1 },
